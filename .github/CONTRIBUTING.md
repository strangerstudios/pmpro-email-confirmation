# Contribute to Paid Memberships Pro - Email Confirmation
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-email-confirmation/issues/new/choose)
...
* For bug fixes, checkout the DEV branch of the Paid Memberships Pro - Email Confirmation repository.
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-email-confirmation.git` to set the upstream repo
...
* For bug fixes, submit a pull request to the DEV branch of the Paid Memberships Pro - Email Confirmation repository.
